...
public class TestCaseSpaceCall8 extends TestSuite {

    /**
     step 1:  P1,P2 call space(contain P1,P2) \n
     step 2:P1 invite P3 \n
     step 2: P3 receive space call \n
     step 3:P1 remove P3 form this space\n
     step 4: P1, P2 leave
     */

    public TestCaseSpaceCall8() {
        this.add(TestCaseSpaceCall8.TestActorCall8Person1.class);
        this.add(TestCaseSpaceCall8.TestActorCall8Person2.class);
        this.add(TestCaseSpaceCall8.TestActorCall8Person3.class);
    }

    @Description("TestActorCall8Person1")
    public static class TestActorCall8Person1 extends RoomCallingTestActor{
        ...
        protected void onCallMembershipChanged(CallObserver.CallEvent event){
            ...
            if(this.person2Joined){
                this.invitePersonThree(event.getCall());
            }
    ...
    @Description("TestActorCall8Person2")
    public static class TestActorCall8Person2 extends RoomCallingTestActor {
    ...
    @Description("TestActorCall8Person3")
    public static class TestActorCall8Person3 extends RoomCallingTestActor {
