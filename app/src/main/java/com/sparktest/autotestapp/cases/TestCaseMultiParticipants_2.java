...
public class TestCaseMultiParticipants_2 extends TestSuite {

    public TestCaseMultiParticipants_2() {
        this.add(TestCaseMultiParticipants_2.Caller1.class);
        this.add(TestCaseMultiParticipants_2.Caller2.class);
        this.add(TestCaseMultiParticipants_2.Callee.class);
    }
